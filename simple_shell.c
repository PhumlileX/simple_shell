"manpage for Simple_shell. Simple shell project for ALX School.
.TH man  "26 April 2023" "Simple Shell"
SH NAME
ALX Simple Shell
...
that reads and executes commands from standard input.
It is conformed to the POSIX specificati>
.LP
...
.B git clone https://github.com/yeshan111/simple_shell.git
br
...
.SH BUGS
Only one error message will print upon failure.
If any further bugs are found please contact the authors.
